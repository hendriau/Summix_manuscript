...
##          library(data.table)
##          
##          datadir = "~/mixtures/genomic_resources/ref_gnomad_mergedata/genome_gnomad-ref-bherer_all_v2/"
...
excall_block_bootstrap <- function(est_ancestries = c("gnomad_AF_afr", "gnomad_AF_amr", "gnomad_AF_asj",
                                   ...
                                   datadir = "~/mixtures/genomic_resources/gnomad/referencemerge_with_pel/exomes_with_bherer/",
                                   name_template = "exome_cmInfo_chrom%_output.txt.gz",
                                   outdir = "~/mixtures/realdata/new_bootstrap/exomes_all/",
                                   nworkers = 4)
{
  library(R.utils)
  library(data.table)
